	...
	const SEAFOAMISLANDS_B4F_POKEBALL
...
SeafoamIslandsB4F_MapEvents:
	...
	def_object_events
	object_event  7,  1, SPRITE_BIRD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Articuno, EVENT_SEAFOAM_ISLANDS_ARTICUNO
	...
	object_event  9, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SeafoamIslandsTMBlizzard, EVENT_SEAFOAM_ISLANDS_TM_BLIZZARD
