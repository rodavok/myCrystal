...
CliffCave_MapEvents:
	...
	warp_event  7,  8, CLIFF_CAVE, 2
    warp_event 17, 21, ROUTE_47, 4
	...
	def_object_events
	object_event  5, 13, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CliffCavePokefanMScript, -1