...
Route6SaffronGate_MapEvents:
	...
	warp_event  3,  5, ROUTE_6, 2
	warp_event  4,  5, ROUTE_6, 2
	...
	def_object_events
	object_event  1,  3, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route6SaffronGuardScript, -1
