...
Route32_MapEvents:
	...
	warp_event  2, 15, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 1
	...
	object_event  3, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route32XAttack, EVENT_ROUTE_32_X_ATTACK
