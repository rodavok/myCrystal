...
CeladonDeptStore1F_MapEvents:
	...
	warp_event 16,  7, CELADON_CITY, 1
	warp_event 12,  1, CELADON_DEPT_STORE_2F, 2
	...
	def_bg_events
	bg_event 14,  1, BGEVENT_READ, CeladonDeptStore1FDirectory
	bg_event  2,  1, BGEVENT_READ, CeladonDeptStore1FElevatorButton

	def_object_events
	object_event 9,   3, SPRITE_RECEPTIONIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore1FReceptionistScript, -1
	object_event 15,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore1FGentlemanScript, -1
	object_event  3,  3, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore1FTeacherScript, -1
