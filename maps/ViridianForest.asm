...
ViridianForest_MapEvents:
	...
	def_warp_events
	warp_event 15, 47, VIRIDIAN_FOREST_GATE_S, 1
	warp_event 16, 47, VIRIDIAN_FOREST_GATE_S, 1
	warp_event 17, 47, VIRIDIAN_FOREST_GATE_S, 2
	warp_event 18, 47, VIRIDIAN_FOREST_GATE_S, 2
