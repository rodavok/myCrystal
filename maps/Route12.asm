...
Route12_MapEvents:
	...
	warp_event 10, 13, ROUTE_12, 4 ;fill in with gate
	warp_event 11, 13, ROUTE_12, 4
	warp_event 11, 19, ROUTE_12, 2

	def_coord_events

	def_bg_events
	bg_event 11, 61, BGEVENT_READ, Route12Sign
	bg_event 13, 11, BGEVENT_READ, FishingSpotSign
	bg_event 14, 32, BGEVENT_ITEM, Route12HiddenElixer

	def_object_events
	object_event  9, 24, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerFisherMartin, -1
	...
	object_event  5, 31, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, TrainerGuitaristKerry, -1
	object_event  7, 46, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerSchoolboyChip, -1
	object_event 15, 88, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 0, TrainerFisherLiam, -1
