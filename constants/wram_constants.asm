...
; wDailyFlags2::
	...
	const DAILYFLAGS2_INDIGO_PLATEAU_EUSINE_FIGHT_F        ; 8
...
; wDailyFlags3::
	...
	const  DAILYFLAGS3_SURGE_REMATCH_F
	const  DAILYFLAGS3_SABRINA_REMATCH_F
	const  DAILYFLAGS3_ERIKA_REMATCH_F
	const  DAILYFLAGS3_JANINE_REMATCH_F
	const  DAILYFLAGS3_MISTY_REMATCH_F
	const  DAILYFLAGS3_BROCK_REMATCH_F
	const  DAILYFLAGS3_BLAINE_REMATCH_F
	const  DAILYFLAGS3_BLUE_REMATCH_F
	const  DAILYFLAGS3_KRIS_BOAT_REMATCH_F
