...
; Johto story events
	...
	const EVENT_GOT_LUCKY_EGG_FROM_ELM
...
; Johto hidden items
	...
	const EVENT_GAVE_SCIENTIST_OLD_AMBER ; unused in Crystal
	const EVENT_GAVE_SCIENTIST_DOME_FOSSIL ; unused in Crystal
	const EVENT_GAVE_SCIENTIST_HELIX_FOSSIL ; unused in Crystal
	...
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_MAX_REVIVE
...
; Kanto hidden items
	...
	const EVENT_VIRIDIAN_FOREST_MAX_ETHER
...
; Restoration Content
	const EVENT_CERULEAN_CAVE_B2F_MAX_ELIXER
	const EVENT_CERULEAN_CAVE_B2F_NUGGET
	const EVENT_CERULEAN_CAVE_B2F_HIDDEN_RARE_CANDY
	const EVENT_CERULEAN_CAVE_B2F_FULL_RESTORE
	const EVENT_CERULEAN_CAVE_B3F_FULL_RESTORE
	const EVENT_CERULEAN_CAVE_B3F_PP_UP
	const EVENT_CERULEAN_CAVE_B3F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B4F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B4F_HIDDEN_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B4F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_B5F_MAX_ELIXER
	const EVENT_CERULEAN_CAVE_B5F_RARE_CANDY
	const EVENT_CERULEAN_CAVE_B5F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B5F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_B5F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_B6F_RARE_CANDY
	const EVENT_CERULEAN_CAVE_B6F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B6F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_B6F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_B6F_FULL_RESTORE
	const EVENT_CERULEAN_CAVE_B7F_MAX_ELIXER
	const EVENT_CERULEAN_CAVE_B7F_ULTRA_BALL1
	const EVENT_CERULEAN_CAVE_B7F_ULTRA_BALL2
	const EVENT_CERULEAN_CAVE_B7F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_B7F_HIDDEN_PP_UP
	const EVENT_GOLDENROD_UNDERGROUND_DOLL_LASS
	const EVENT_POWERPLANTB1F_ELECTRODE1
	const EVENT_POWERPLANTB1F_ELECTRODE2
	const EVENT_POWERPLANTB1F_ELECTRODE3
	const EVENT_POWERPLANTB1F_ELECTRODE4
	const EVENT_POWERPLANTB1F_ELECTRODE5
	const EVENT_POWERPLANTB1F_ELECTRODE6
	const EVENT_POWERPLANTB1F_ELECTRODE7
	const EVENT_POWERPLANTB1F_ELECTRODE8
	const EVENT_POWERPLANTB1F_CARBOS
	const EVENT_POWERPLANTB1F_HP_UP
	const EVENT_POWERPLANTB1F_RARE_CANDY
	const EVENT_POWERPLANTB1F_TM_THUNDER
	const EVENT_POWERPLANTB1F_RARE_CANDY2

	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_1F_1
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_1F_2
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_1F_1A
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_1F_2A
    const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B1F_1A
    const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B1F_2A
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B2F_1A
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B2F_2A
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B3F_3
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B3F_4
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B3F_3A
	const EVENT_BOULDER_IN_SEAFOAM_ISLANDS_B3F_4A
	const EVENT_SEAFOAM_ISLANDS_HIDDEN_NUGGET
	const EVENT_SEAFOAM_ISLANDS_HIDDEN_MAX_ELIXER
	...
	const EVENT_SAFARI_ZONE_EAST_TM_52
	const EVENT_SAFARI_ZONE_NORTH_PROTEIN
	const EVENT_SAFARI_ZONE_NORTH_TM_53
	const EVENT_SAFARI_ZONE_WEST_TM_32
	const EVENT_SAFARI_ZONE_WEST_MAX_POTION
	const EVENT_SAFARI_ZONE_WEST_MAX_REVIVE
	const EVENT_SAFARI_ZONE_WEST_HIDDEN_REVIVE
	const EVENT_GOT_GOLD_TEETH
	const EVENT_GAVE_GOLD_TEETH_TO_WARDEN
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_RECEIVED_RIVAL_EGG
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_ROSS3
	const EVENT_BEAT_COOLTRAINERM_TOMMY3
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_SOPHIE3
	const EVENT_BEAT_COOLTRAINERF_DONNA3
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_BEAUTY_EDA
	const EVENT_BEAT_SUPERNERD_KAE
	const EVENT_BEAT_CAMPER_GRANT
	const EVENT_BEAT_HIKER_DEVIN
	
	const EVENT_BEAT_GUITARIST_KERRY
	const EVENT_BEAT_SCHOOLBOY_CHIP
	const EVENT_BEAT_FISHER_LIAM
	const EVENT_BEAT_YOUNGSTER_TEDDY
	const EVENT_BEAT_TEACHER_SADAYO
	const EVENT_BEAT_YOUNGSTER_FINN
	const EVENT_BEAT_JUGGLER_JIMBO
	const EVENT_BEAT_PSYCHIC_EZRA
	const EVENT_BEAT_TEACHER_ANITA
	const EVENT_BEAT_COOLTRAINERM_HUNTER
	const EVENT_BEAT_COOLTRAINERF_ALEXA
	const EVENT_BEAT_TEACHER_BETTIE
	const EVENT_BEAT_SUPER_NERD_DEXTER
	const EVENT_BEAT_TEACHER_DAPHNE
	const EVENT_BEAT_BIKER_KIMBER
	const EVENT_BEAT_BIKER_COOPER
	const EVENT_BEAT_BIKER_SMITH
	const EVENT_BEAT_BIKER_BARRETT
	const EVENT_BEAT_BIKER_KOCH
	const EVENT_BEAT_SWIMMERF_HILDA
	const EVENT_BEAT_SWIMMERM_YANG
	const EVENT_BEAT_BIRDKEEPER_BUDDY
	const EVENT_BEAT_SWIMMERF_ALIA
	const EVENT_BEAT_SWIMMERM_STEVE
	const EVENT_BEAT_FISHER_TRENT
	const EVENT_BEAT_FISHER_VINCE
	const EVENT_BEAT_FISHER_DALE
	const EVENT_BEAT_SWIMMERM_HIDEO
...
; Johto itemballs
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_ELIXER
...
; New to Crystal
	...
	const EVENT_ROUTE_34_EGG_TICKET
	const EVENT_ROUTE_44_RARE_CANDY
	...
	const EVENT_VICTORY_ROAD_LUCKY_EGG
	const EVENT_RUINS_OUTSIDE_EGG_TICKET
	const EVENT_POWERPLANT_ZAPDOS
	const EVENT_MT_MOON_SQUARE_MOLTRES
	...
	const EVENT_GOT_GIOVANNI_PRIZE
	const EVENT_CERULEAN_CAVE_MEWTWO
	const EVENT_FOUGHT_MEWTWO
	const EVENT_SENTEI
	const EVENT_SRAIKOU
	const EVENT_SSUICUNE
	const EVENT_FOUGHT_SENTEI
	const EVENT_FOUGHT_SRAIKOU
	const EVENT_FOUGHT_SSUICUNE
	const EVENT_SILVER_CAVE_MEW_ROOM_MEW
	const EVENT_FOUGHT_MEW
	const EVENT_GOT_MR_POKEMON_MON
	const EVENT_CHERRYGROVE_RARE_CANDY
	...
	const EVENT_CLIFF_EDGE_GATE_BIG_PEARL
	const EVENT_ROUTE_47_REVIVE
	const EVENT_ROUTE_47_PEARL
	const EVENT_ROUTE_47_STARDUST
	const EVENT_ROUTE_47_EGG_TICKET
