...
.PayoutStrings:
	...
	dbw "3000", .LinedUpSevens      ; SLOTS_SEVEN
	dbw "250@", .LinedUpPokeballs   ; SLOTS_POKEBALL
	dbw "10@@", .LinedUpMonOrCherry ; SLOTS_CHERRY
	dbw "25@@", .LinedUpMonOrCherry ; SLOTS_PIKACHU
	dbw "75@@", .LinedUpMonOrCherry ; SLOTS_SQUIRTLE
	dbw "50@@", .LinedUpMonOrCherry ; SLOTS_STARYU
	assert_table_length NUM_SLOT_REELS
