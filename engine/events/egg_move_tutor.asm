	const_def
	const EGGMOVETUTORTEXT_INTRO
	const EGGMOVETUTORTEXT_WHICHMON
	const EGGMOVETUTORTEXT_WHICHMOVE
	const EGGMOVETUTORTEXT_COMEAGAIN
	const EGGMOVETUTORTEXT_EGG
	const EGGMOVETUTORTEXT_NOTAPOKEMON
	const EGGMOVETUTORTEXT_NOTENOUGHMONEY
	const EGGMOVETUTORTEXT_NOMOVESTOLEARN

EggMoveTutor:
	ld a, EGGMOVETUTORTEXT_INTRO
	...
	ld a, EGGMOVETUTORTEXT_WHICHMON
	call PrintEggMoveTutorText
	call JoyWaitAorB
...
.skip_learn
	...
	call SpeechTextbox
.cancel
	ld a, EGGMOVETUTORTEXT_COMEAGAIN
	call PrintEggMoveTutorText
	ret
.egg
	ld a, EGGMOVETUTORTEXT_EGG
	call PrintEggMoveTutorText
	ret
.not_enough_money
	ld a, EGGMOVETUTORTEXT_NOTENOUGHMONEY
	call PrintEggMoveTutorText
	ret
.no_mon
	ld a, EGGMOVETUTORTEXT_NOTAPOKEMON
	call PrintEggMoveTutorText
	ret
.no_moves
	ld a, EGGMOVETUTORTEXT_NOMOVESTOLEARN
	call PrintEggMoveTutorText
	ret
...
CheckPokemonAlreadyKnowsMoveEgg:
