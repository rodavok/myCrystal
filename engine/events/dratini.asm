...
; Dratini sucks for a long time so this cool gift also includes Dragon Dance so it can at least be a little useful
	db LEER
	db THUNDER_WAVE
	db DRAGON_DANCE
	db EXTREMESPEED
	db 0
.Moveset1:
; This is the normal moveset of a level 25 Dratini
	db LEER
	db THUNDER_WAVE
	db TWISTER
	db DRAGON_RAGE
