...
MapGroup_Dungeons:
	...
	map TohjoFallsGiovanniRoom, TILESET_CAVE, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map SafariZoneFuchsiaGateBeta, TILESET_MUSEUM, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneCenter, TILESET_VIRIDIANFOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_VIRIDIANFOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneNorth, TILESET_VIRIDIANFOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneWest, TILESET_VIRIDIANFOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
...
MapGroup_Cinnabar:
	...
	map CinnabarPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route19FuchsiaGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SeafoamCave, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map SeafoamIslandsNorth, TILESET_CAVE, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_DAY, FISHGROUP_OCEAN
	map SeafoamIslands1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	assert_table_length NUM_CINNABAR_MAPS

MapGroup_Cerulean:
	table_width MAP_LENGTH, MapGroup_Cerulean
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route10Pokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanCave1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCave2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB3F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB4F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB5F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB6F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB7F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON1, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map PowerPlantB1F, TILESET_FACILITY_RBY, CAVE, LANDMARK_POWER_PLANT, MUSIC_DUNGEON3, FALSE, PALETTE_DARK, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map GoldenrodShore, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VermilionMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route11Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Gate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route3Pokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_MT_MOON, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route13, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map FuchsiaMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route15FuchsiaGate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map LavenderPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map SilverCaveMewRoom, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Celadon:
	...
	map CeladonDeptStore1F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route16Gate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map GoldenrodPier, TILESET_JOHTO, ROUTE, LANDMARK_GOLDENROD_CITY, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GoldenrodPierGate, TILESET_GATE, GATE, LANDMARK_GOLDENROD_CITY, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CliffEdgeGate, TILESET_CAVE, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_36, FALSE, PALETTE_NITE, FISHGROUP_POND
	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CliffCave, TILESET_CAVE, CAVE, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_47, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map SafariZoneGate, TILESET_JOHTO, TOWN, LANDMARK_CIANWOOD_CITY, MUSIC_SAFARI_ZONE_GATE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, ROUTE, LANDMARK_CIANWOOD_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneBetaGate, TILESET_GATE, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_SAFARI_ZONE_GATE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForestGateS, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateN, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_VIRIDIANFOREST, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SaffronMart, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_POKECENTER_RBY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
