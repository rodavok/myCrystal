...
MapGroup_Cinnabar:
	...
	map SeafoamCave, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map SeafoamIslandsNorth, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	...
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCave2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB3F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB4F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB5F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB6F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB7F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
