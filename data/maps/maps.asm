...
MapGroup_Pewter:
	...
	map Route3Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_MT_MOON, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianForestGateS, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateN, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
