...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_VIRIDIANFOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map PowerPlant, TILESET_FACILITY_RBY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_DUNGEON3, FALSE, PALETTE_DARK, FISHGROUP_SHORE
