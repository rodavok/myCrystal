...
INCLUDE "data/pokemon/base_stats/pyroped.asm"
INCLUDE "data/pokemon/base_stats/yanmato.asm"
...
INCLUDE "data/pokemon/base_stats/nyqwil.asm"
INCLUDE "data/pokemon/base_stats/licking.asm"
