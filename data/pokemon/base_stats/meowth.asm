	...
	; tm/hm learnset
    tmhm DOUBLE_EDGE, TAKE_DOWN, THUNDER, TOXIC,SWIFT, RETURN, THUNDER, PSYCH_UP, ZAP_CANNON, DREAM_EATER, DOUBLE_TEAM, SNORE, ATTRACT, SUNNY_DAY, REST, THIEF,BODY_SLAM, SWIFT,AMNESIA, THUNDERBOLT, ENDURE,THUNDERBOLT, NIGHTMARE,BUBBLEBEAM, MUD_SLAP, PROTECT, FRUSTRATION, CURSE, DEFENSE_CURL, HIDDEN_POWER, ICY_WIND,SKULL_BASH,CHARM,HYPNOSIS, HEADBUTT, DETECT, SHADOW_BALL, IRON_TAIL, SLEEP_TALK, SWAGGER	; end
