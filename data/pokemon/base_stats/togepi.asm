	...
	; tm/hm learnset
    tmhm  THUNDER_WAVE, METRONOME, ROCK_SMASH, TOXIC, RETURN, FLASH, PSYCH_UP, ZAP_CANNON, DREAM_EATER, DOUBLE_TEAM, SNORE, ATTRACT, SUNNY_DAY, REST,PRESENT, FLAMETHROWER, SWIFT, SOFTBOILED,FUTURE_SIGHT, ENDURE, RAIN_DANCE, SOLARBEAM, MUD_SLAP, PROTECT, FRUSTRATION, CURSE, ROLLOUT, HIDDEN_POWER, DEFENSE_CURL, PSYCHIC_M, FIRE_BLAST, HEADBUTT, DETECT, SHADOW_BALL, SLEEP_TALK, SWAGGER, TAKE_DOWN, DOUBLE_EDGE	; end
