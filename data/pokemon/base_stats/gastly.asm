	...
	; tm/hm learnset
    tmhm PAIN_SPLIT, THUNDER, SLUDGE_BOMB, TOXIC, RETURN, THUNDER, PSYCH_UP, ZAP_CANNON, DREAM_EATER, DOUBLE_TEAM, SNORE,MEGA_DRAIN, ATTRACT, SUNNY_DAY, GIGA_DRAIN, REST, THIEF, SLUDGE_BOMB,DREAM_EATER, THUNDERBOLT,PSYBEAM, ENDURE,THUNDERBOLT, RAIN_DANCE, NIGHTMARE,SELFDESTRUCT, PROTECT, FRUSTRATION, CURSE,EXPLOSION, HIDDEN_POWER, PSYCHIC_M,PERISH_SONG, SHADOW_BALL, SLEEP_TALK, SWAGGER	; end
