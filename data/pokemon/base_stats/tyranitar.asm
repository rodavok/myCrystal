	...
	; tm/hm learnset
    tmhm  DRAGON_DANCE, CRUNCH, CUT, ROCK_SMASH, SURF, TOXIC, HYPER_BEAM, RETURN, ROAR, ICE_BEAM, DOUBLE_TEAM, SNORE, ATTRACT, SUNNY_DAY, REST, FIRE_PUNCH, EARTHQUAKE, FLAMETHROWER,OUTRAGE, THUNDERBOLT,ANCIENTPOWER, ENDURE, RAIN_DANCE, NIGHTMARE, MUD_SLAP, PROTECT, FRUSTRATION, DYNAMICPUNCH, CURSE, HIDDEN_POWER, DRAGONBREATH,PURSUIT, FIRE_BLAST, HEADBUTT, DETECT, FURY_CUTTER, STRENGTH, IRON_TAIL, DIG, SLEEP_TALK, SANDSTORM, SWAGGER	; end
