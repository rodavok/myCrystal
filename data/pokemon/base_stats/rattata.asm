	...
	; tm/hm learnset
    tmhm  DOUBLE_EDGE, TAKE_DOWN, ROCK_SMASH,THUNDER, TOXIC,SWIFT, RETURN,BITE, THUNDER,COUNTER, DOUBLE_TEAM, SNORE, ATTRACT, SUNNY_DAY, REST, THIEF,DIG,BODY_SLAM, SWIFT,SCREECH,FLAME_WHEEL, ENDURE,THUNDERBOLT,BUBBLEBEAM, MUD_SLAP, PROTECT, FRUSTRATION, CURSE, DEFENSE_CURL, HIDDEN_POWER, ICY_WIND,SKULL_BASH,REVERSAL, HEADBUTT, SHADOW_BALL, IRON_TAIL, BLIZZARD, DIG, SLEEP_TALK,BLIZZARD, SWAGGER	; end
