...
Rival1Group:
	...
	db 18, LARVITAR,   BITE, SCREECH, ROCK_SLIDE, SANDSTORM
	db -1 ; end
	...
	db 31, PUPITAR,    BITE, ROCK_SLIDE, THRASH, SANDSTORM
	db -1 ; end
	...
	db 36, PUPITAR,    BITE, ROCK_SLIDE, THRASH, SANDSTORM
...
MysticalmanGroup:
	...
	db 25, MISDREAVUS, CONFUSE_RAY, PERISH_SONG, PAIN_SPLIT, TOXIC
