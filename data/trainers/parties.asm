...
WhitneyGroup:
	...
	db  71, SNORLAX,     BODY_SLAM, REST, SNORE, SHADOW_BALL
	db -1 ; end
...
ClairGroup:
	...
	; CLAIR (2)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 62, DRAGONITE,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 62, DRAGONITE,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 62, DRAGONITE,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	...
	db 73, GYARADOS,   ROAR, WATERFALL, REST, BITE
...
BlaineGroup:
	...
	db 65, FLAREON,    FIRE_BLAST, SHADOW_BALL, BITE, CHARM
	db -1 ; end
