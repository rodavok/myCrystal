...
BugsyGroup:
	...
	db  75, BEEDRILL, PIN_MISSILE, SLUDGE_BOMB, SWORDS_DANCE, TWINEEDLE
	db  73, KABUTOPS, SLASH, ANCIENTPOWER, SURF, RAIN_DANCE
	db  75, BUTTERFREE, SLEEP_POWDER, PSYCHIC_M, NIGHTMARE, DOUBLE_TEAM
	db  72, PINSIR,   SUBMISSION, BODY_SLAM, GUILLOTINE, HARDEN
	db	72, SCYTHER,   AGILITY, WING_ATTACK, FURY_CUTTER, QUICK_ATTACK
	db -1 ; end
...
MortyGroup:
	...
	db  72, MISDREAVUS,  THUNDER, TOXIC, THIEF, PAIN_SPLIT
