...
RocketBossGroup:
	...
	db 72, NIDOKING, HORN_DRILL, FOCUS_ENERGY, DOUBLE_KICK, SLUDGE_BOMB
	db 76, NIDOQUEEN, BITE, ROAR, EARTHQUAKE, ATTRACT
	db 77, PERSIAN, SLASH, GLARE, BITE, PAY_DAY
	db 78, MURKROW, SKY_ATTACK, THIEF, MIRROR_MOVE, WHIRLWIND
	db 70, KANGASKHAN, BITE, HYPER_BEAM, REVERSAL, REST
	db 75, RHYDON, EARTHQUAKE, ROCK_SLIDE, REST, SLEEP_TALK
	db -1
