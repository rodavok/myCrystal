...
; moves
	...
	db MONMENU_FIELD_MOVE, MONMENUITEM_CUT,		   CROSS_CUTTER
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,        FLY
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,		   WING_ATTACK
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,		   DRILL_PECK
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,		   SKY_ATTACK
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,        STEEL_WING
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       SURF
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       OCTAZOOKA
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       HYDRO_PUMP
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       WATERFALL
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       WHIRLPOOL
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       CRABHAMMER
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRENGTH,   STRENGTH
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRENGTH,   DOUBLE_EDGE
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRENGTH,   BODY_SLAM
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRENGTH,   CRABHAMMER
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FLASH
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      THUNDERSHOCK
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      THUNDERBOLT
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      THUNDERPUNCH
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      THUNDER
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      SPARK
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      EMBER
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FLAMETHROWER
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FLAME_WHEEL
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FIRE_PUNCH
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FIRE_BLAST
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATERFALL,  WATERFALL
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATERFALL,  OCTAZOOKA
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATERFALL,  CRABHAMMER
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATERFALL,  HYDRO_PUMP
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  WHIRLPOOL
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  WATERFALL
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  CLAMP
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  HYDRO_PUMP
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  OCTAZOOKA
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  CRABHAMMER
	...
	db MONMENU_FIELD_MOVE, MONMENUITEM_HEADBUTT,   SLAM
	db MONMENU_FIELD_MOVE, MONMENUITEM_HEADBUTT,   BODY_SLAM
	db MONMENU_FIELD_MOVE, MONMENUITEM_ROCKSMASH,  ROCK_SMASH
	db MONMENU_FIELD_MOVE, MONMENUITEM_ROCKSMASH,  DYNAMICPUNCH
	db MONMENU_FIELD_MOVE, MONMENUITEM_ROCKSMASH,  KARATE_CHOP
	db MONMENU_FIELD_MOVE, MONMENUITEM_ROCKSMASH,  CROSS_CHOP
