...
PyropedBitmasks:     INCLUDE "gfx/pokemon/pyroped/bitmask.asm"
YanmatoBitmasks:    INCLUDE "gfx/pokemon/yanmato/bitmask.asm"
...
NyqwilBitmasks:     INCLUDE "gfx/pokemon/nyqwil/bitmask.asm"
LickingBitmasks:  INCLUDE "gfx/pokemon/licking/bitmask.asm"
