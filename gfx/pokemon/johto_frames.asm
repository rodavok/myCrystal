...
PyropedFrames:     INCLUDE "gfx/pokemon/pyroped/frames.asm"
YanmatoFrames:    INCLUDE "gfx/pokemon/yanmato/frames.asm"
...
NyqwilFrames:     INCLUDE "gfx/pokemon/nyqwil/frames.asm"
LickingFrames:    INCLUDE "gfx/pokemon/licking/frames.asm"
